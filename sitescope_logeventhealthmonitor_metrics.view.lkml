view: sitescope_logeventhealthmonitor_metrics {
  ...
  dimension: _business_availability_center_server_ {
    type: number
    sql: ${TABLE}._business_availability_center_server_ ;;
  }
  ...
  dimension: _error_business_availability_center_failed_to_process_data_ {
    type: number
    sql: ${TABLE}._error_business_availability_center_failed_to_process_data_ ;;
  }
  ...
  dimension: _failed_to_report_data_to_om_agent_ {
    type: number
    sql: ${TABLE}._failed_to_report_data_to_om_agent_ ;;
  }
  ...
  dimension: _skipped_1_ {
    type: number
    sql: ${TABLE}._skipped_1_ ;;
  }

  dimension: _skipped_2_ {
    type: number
    sql: ${TABLE}._skipped_2_ ;;
  }
